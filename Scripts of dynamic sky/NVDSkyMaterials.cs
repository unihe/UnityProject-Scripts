...
internal class NVDSkyMaterials : MaterialEditor
{
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static void Header()
    {
        ...
        EditorGUILayout.LabelField("#NVJOB Dynamic Sky (v2.5)", guiStyle);
    ...
    public static void Information()
    {
        ...
        if (GUILayout.Button("Description and Instructions")) Help.BrowseURL("https://nvjob.github.io/unity/nvjob-dynamic-sky-lite");
...
public class DynamicSkyEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUI.BeginChangeCheck();
        NVDSkyMaterials.Header();
        NVDSkyMaterials.DrawUILine(bgLineColor, 2, bgLinePadding);
